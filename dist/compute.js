...
export function computeUtSeries(turnScores, W = DEFAULT_WEIGHTS) {
    let prevUt = 0;
...
export function meanDims(series) {
...
export function trajectoryLabel(Ut) {
    if (Ut.length < 6)
        return "flat";
